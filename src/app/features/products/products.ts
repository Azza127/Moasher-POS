...
export class Products implements OnInit {
  ...
  confirmDelete(): void {
    ...
    // ملاحظة: تأكدي من مواءمة اسم الميثود مع ProductService (مثلاً deleteProduct أو delete)
  ...
  saveNewCategory(): void {
    ...
    // تأكدي أن اسم الميثود في الـ CategoryService هو addCategory أو createCategory
